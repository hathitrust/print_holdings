...
def merge_clusters (cid1, cid2)
  ...
  queryc1a = "SELECT volume_id FROM holdings_cluster_htitem_jn WHERE cluster_id = '#{cid1}'"
  queryc2a = "SELECT volume_id FROM holdings_cluster_htitem_jn WHERE cluster_id = '#{cid2}'"
  c1vids = run_list_query(queryc1a)
  c2vids = run_list_query(queryc2a)
  ...
  mcquery5a = "DELETE FROM holdings_cluster_htitem_jn WHERE cluster_id = '#{cid2}'"
  mcquery5c = "DELETE FROM holdings_cluster WHERE cluster_id = '#{cid2}'"

  @conn.execute(mcquery5a)
  @conn.execute(mcquery5c)  
end
